...
function BusBulletins() {
  return (
    <div className="mx-auto max-w-screen-xl ">
      <div className="mb-5 mt-5 flex justify-between border-b text-sm">
        <div className="flex items-center border-b-2 border-red-600 pb-2 pr-2 uppercase text-red-600">
          {/* <svg
            className="mr-3 h-6"
            version="1.1"
            id="Capa_1"
      ...
      <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 md:grid-cols-3">
        ...
        <div className="flex flex-col overflow-hidden rounded shadow-lg">
          ...
          <div className="relative">
            ...
            <a href="#!">
              <div className="absolute right-0 top-0 mr-3 mt-3 bg-red-600 px-4 py-2 text-xs text-white transition duration-500 ease-in-out hover:bg-white hover:text-red-600">
                Business
              </div>
            </a>
          </div>
          <div className="mb-auto px-6 py-4">
            <a
              href="#"
              className="mb-2 inline-block inline-block text-lg font-medium transition duration-500 ease-in-out hover:text-red-600">
